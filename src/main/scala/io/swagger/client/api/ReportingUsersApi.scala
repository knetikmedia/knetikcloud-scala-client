...
class ReportingUsersApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def executiveRevenueItemSalesUsingGET1(granularity: Option[String] /* = day*/, startDate: Option[Long] = None, endDate: Option[Long] = None): Option[PageResourceAggregateCountResource] = {
