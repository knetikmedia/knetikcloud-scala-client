...
class ReportingUsersApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def executiveRevenueItemSalesUsingGET1(granularity: Option[String] /* = day*/, startDate: Option[Long] = None, endDate: Option[Long] = None): Option[PageAggregateCountResource] = {
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(ApiInvoker.deserialize(s, "", classOf[PageAggregateCountResource]).asInstanceOf[PageAggregateCountResource])
        case _ => None
      }
    } catch {
