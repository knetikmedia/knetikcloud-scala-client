...
class LocationsApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def getCities(countryCodeIso3: String, stateCode: String): Option[List[CityResource]] = {
    ...
    if (countryCodeIso3 == null) throw new Exception("Missing required parameter 'countryCodeIso3' when calling LocationsApi->getCities")

    if (stateCode == null) throw new Exception("Missing required parameter 'stateCode' when calling LocationsApi->getCities")
   ...
   */
  def getCountries1(): Option[List[CountryResource]] = {
    // create path and map variables
   ...
   */
  def getCountries2(countryCodeIso3: String): Option[List[StateResource]] = {
    // create path and map variables
    ...
    if (countryCodeIso3 == null) throw new Exception("Missing required parameter 'countryCodeIso3' when calling LocationsApi->getCountries2")
