...
class CategoriesApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getArticleTemplatesUsingGET1(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceTemplateResource] = {
    // create path and map variables
    val path = "/categories/templates".replaceAll("\\{format\\}", "json")
   ...
   */
  def getCategoriesUsingGET1(filterSearch: Option[String] = None, filterActive: Option[Boolean] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceCategoryResource] = {
    // create path and map variables
    val path = "/categories".replaceAll("\\{format\\}", "json")
   ...
   */
  def getTagsUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourcestring] = {
    // create path and map variables
