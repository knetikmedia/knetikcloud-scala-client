...
class MediaModerationApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getFlagsReportUsingGET(excludeResolved: Option[Boolean] /* = true*/, filterContext: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceFlagReportResource] = {
    // create path and map variables
