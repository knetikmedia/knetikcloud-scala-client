...
class ReportingUsageApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getUsageByDayUsingGET(startDate: Long, endDate: Long, combineEndpoints: Option[Boolean] /* = false*/, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceUsageInfo] = {
   ...
   * @return PageResourceUsageInfo
   */
  def getUsageByHourUsingGET(startDate: Long, endDate: Long, combineEndpoints: Option[Boolean] /* = false*/, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceUsageInfo] = {
    // create path and map variables
   ...
   * @return PageResourceUsageInfo
   */
  def getUsageByMinuteUsingGET(startDate: Long, endDate: Long, combineEndpoints: Option[Boolean] /* = false*/, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceUsageInfo] = {
    // create path and map variables
   ...
   * @return PageResourceUsageInfo
   */
  def getUsageByMonthUsingGET(startDate: Long, endDate: Long, combineEndpoints: Option[Boolean] /* = false*/, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceUsageInfo] = {
    // create path and map variables
   ...
   * @return PageResourceUsageInfo
   */
  def getUsageByYearUsingGET(startDate: Long, endDate: Long, combineEndpoints: Option[Boolean] /* = false*/, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceUsageInfo] = {
    // create path and map variables
