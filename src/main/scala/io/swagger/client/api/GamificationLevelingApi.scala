...
class GamificationLevelingApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   * @return void
   */
  def updateLevel(name: String, newLevel: Option[LevelingResource] = None) = {
    // create path and map variables
    val path = "/leveling/{name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "name" + "\\}",apiInvoker.escape(name))
   ...
   * @return void
   */
  def updateUserLevel(userId: Integer, name: String, progress: Option[Integer] = None) = {
    // create path and map variables
    val path = "/users/{user_id}/leveling/{name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "user_id" + "\\}",apiInvoker.escape(userId)).replaceAll("\\{" + "name" + "\\}",apiInvoker.escape(name))
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling GamificationLevelingApi->updateUserLevel")
