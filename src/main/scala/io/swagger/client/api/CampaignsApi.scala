...
class CampaignsApi(val defBasePath: String = "https://localhost:8080/",
   ...
   * @return void
   */
  def updateCampaign(id: Long, campaignResource: Option[CampaignResource] = None) = {
    // create path and map variables
    val path = "/campaigns/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
   ...
   * @return void
   */
  def updateCampaignTemplate(id: String, campaignTemplateResource: Option[TemplateResource] = None) = {
    // create path and map variables
    val path = "/campaigns/templates/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
