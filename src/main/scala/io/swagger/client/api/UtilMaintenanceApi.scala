...
class UtilMaintenanceApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   * @return Maintenance
   */
  def getUsingGET1(): Option[Maintenance] = {
    // create path and map variables
    val path = "/maintenance".replaceAll("\\{format\\}", "json")
   ...
   * @return void
   */
  def postUsingPOST(maintenance: Option[Maintenance] = None) = {
    // create path and map variables
    val path = "/maintenance".replaceAll("\\{format\\}", "json")
   ...
   * @return void
   */
  def postUsingPUT(maintenance: Option[Maintenance] = None) = {
    // create path and map variables
    val path = "/maintenance".replaceAll("\\{format\\}", "json")
