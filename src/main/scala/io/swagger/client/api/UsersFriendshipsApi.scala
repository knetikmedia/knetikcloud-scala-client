...
class UsersFriendshipsApi(val defBasePath: String = "https://devsandbox.knetikcloud.com/",
   ...
   */
  def getFriendsUsingGET(userId: String, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageSimpleUserResource] = {
    // create path and map variables
   ...
   * @return PageSimpleUserResource
   */
  def getInvitesUsingGET(userId: String, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageSimpleUserResource] = {
    // create path and map variables
