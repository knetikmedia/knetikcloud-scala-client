...
class UsersFriendshipsApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getFriends(userId: String, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceSimpleUserResource] = {
    // create path and map variables
   ...
   * @return PageResourceSimpleUserResource
   */
  def getInvites(userId: String, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceSimpleUserResource] = {
    // create path and map variables
