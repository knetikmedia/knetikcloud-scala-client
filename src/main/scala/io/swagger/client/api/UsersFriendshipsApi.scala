...
class UsersFriendshipsApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getFriendsUsingGET(userId: String, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceSimpleUserResource] = {
    // create path and map variables
   ...
   * @return PageResourceSimpleUserResource
   */
  def getInvitesUsingGET(userId: String, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceSimpleUserResource] = {
    // create path and map variables
