...
class ReportingOrdersApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def getDailyInvoicesUsingGET(currencyCode: String, granularity: Option[String] /* = day*/, filterPaymentStatus: Option[String] = None, filterFulfillmentStatus: Option[String] = None, startDate: Option[Long] = None, endDate: Option[Long] = None): Option[PageAggregateInvoiceReportResource] = {
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(ApiInvoker.deserialize(s, "", classOf[PageAggregateInvoiceReportResource]).asInstanceOf[PageAggregateInvoiceReportResource])
        case _ => None
      }
    } catch {
