...
class ReportingOrdersApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getInvoiceReports(currencyCode: String, granularity: Option[String] /* = day*/, filterPaymentStatus: Option[String] = None, filterFulfillmentStatus: Option[String] = None, startDate: Option[Long] = None, endDate: Option[Long] = None): Option[PageResourceAggregateInvoiceReportResource] = {
