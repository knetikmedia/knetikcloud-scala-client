...
class AuthTokensApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def getTokensUsingGET(filterClientId: Option[String] = None, filterUsername: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageOauthAccessTokenResource] = {
    // create path and map variables
