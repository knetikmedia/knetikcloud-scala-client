...
class PaymentsStripeApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def createCustomerUsingPOST(request: Option[StripeCreatePaymentMethod] = None): Option[PaymentMethodResource] = {
