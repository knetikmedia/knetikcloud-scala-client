...
class UsersSubscriptionsApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getSubscriptionDetailsUsingGET(userId: Integer, inventoryId: Integer): Option[InventorySubscriptionResource] = {
   ...
   */
  def getSubscriptionDetailsUsingGET1(userId: Integer): Option[List[InventorySubscriptionResource]] = {
    // create path and map variables
   ...
   */
  def reactivateUsingPOST(userId: Integer, inventoryId: Integer, reactivateSubscriptionRequest: Option[ReactivateSubscriptionRequest] = None): Option[InvoiceResource] = {
    // create path and map variables
   ...
   * @return void
   */
  def setBillDateUsingPUT(userId: Integer, inventoryId: Integer, billDate: Long) = {
    // create path and map variables
   ...
   * @return void
   */
  def setPaymentMethodUsingPUT(userId: Integer, inventoryId: Integer, paymentMethodId: Option[Integer] = None) = {
    // create path and map variables
   ...
   * @return void
   */
  def setStatusUsingPUT(userId: Integer, inventoryId: Integer, status: String) = {
    // create path and map variables
    ...
    if (status == null) throw new Exception("Missing required parameter 'status' when calling UsersSubscriptionsApi->setStatusUsingPUT")
   ...
   * @return void
   */
  def setUserPlanUsingPUT(userId: Integer, inventoryId: Integer, planId: Option[String] = None) = {
    // create path and map variables
