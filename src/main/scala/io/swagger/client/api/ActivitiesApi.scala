...
class ActivitiesApi(val defBasePath: String = "https://localhost:8080/",
   ...
   * @return void
   */
  def completeActivityOccurrenceUsingPUT(activityOccurrenceId: Long, activityCccurrenceStatus: Option[String] = None) = {
   ...
   */
  def createActivityOccurrenceUsingPOST(test: Option[Boolean] /* = false*/, activityOccurrenceResource: Option[ActivityOccurrenceResource] = None): Option[ActivityOccurrenceResource] = {
    // create path and map variables
   ...
   */
  def createActivityUsingPOST(activityResource: Option[ActivityResource] = None): Option[ActivityResource] = {
    // create path and map variables
   ...
   * @return void
   */
  def deleteActivityUsingDELETE(id: Long) = {
    // create path and map variables
   ...
   */
  def getActivitiesUsingGET(filterTemplate: Option[Boolean] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageBareActivityResource] = {
    // create path and map variables
    val path = "/activities".replaceAll("\\{format\\}", "json")
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(ApiInvoker.deserialize(s, "", classOf[PageBareActivityResource]).asInstanceOf[PageBareActivityResource])
        case _ => None
      }
    } catch {
      case ex: ApiException if ex.code == 404 => None
   ...
   * @return ActivityResource
   */
  def getActivityUsingGET(id: Long): Option[ActivityResource] = {
    // create path and map variables
    val path = "/activities/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
   ...
   */
  def postResultsUsingPOST(activityOccurrenceId: Long, activityOccurrenceResults: Option[ActivityOccurrenceResults] = None): Option[ActivityOccurrenceResults] = {
    // create path and map variables
   ...
   * @return void
   */
  def updateActivityUsingPUT(id: Long, activityResource: Option[ActivityResource] = None) = {
    // create path and map variables
    val path = "/activities/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
