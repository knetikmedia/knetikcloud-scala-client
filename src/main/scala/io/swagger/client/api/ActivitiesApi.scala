...
class ActivitiesApi(val defBasePath: String = "https://devsandbox.knetikcloud.com/",
   ...
   */
  def getActivitiesUsingGET(filterTemplate: Option[Boolean] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageBareActivityResource] = {
    // create path and map variables
    val path = "/activities".replaceAll("\\{format\\}", "json")
