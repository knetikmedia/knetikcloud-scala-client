...
class ActivitiesApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getActivitiesUsingGET(filterTemplate: Option[Boolean] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceBareActivityResource] = {
    // create path and map variables
    val path = "/activities".replaceAll("\\{format\\}", "json")
