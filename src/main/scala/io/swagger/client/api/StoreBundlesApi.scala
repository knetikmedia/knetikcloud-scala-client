...
class StoreBundlesApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   * @return BundleItem
   */
  def createBundleItem(bundleItem: Option[BundleItem] = None): Option[BundleItem] = {
   ...
   * @return void
   */
  def updateBundleItem(id: Integer, bundleItem: Option[BundleItem] = None) = {
    // create path and map variables
    val path = "/store/bundles/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
   ...
   * @return void
   */
  def updateBundleTemplate(id: String, bundleTemplateResource: Option[ItemTemplateResource] = None) = {
    // create path and map variables
    val path = "/store/bundles/templates/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
