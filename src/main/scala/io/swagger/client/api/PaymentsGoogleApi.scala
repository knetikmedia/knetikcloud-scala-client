...
class PaymentsGoogleApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   * @return Integer
   */
  def handlePaymentUsingPOST(request: Option[GooglePaymentRequest] = None): Option[Integer] = {
