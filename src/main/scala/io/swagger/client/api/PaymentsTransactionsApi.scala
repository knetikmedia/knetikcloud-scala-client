...
class PaymentsTransactionsApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getTransactionsUsingGET(filterInvoice: Option[Integer] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceTransactionResource] = {
    // create path and map variables
