...
class PaymentsTransactionsApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def getTransactionsUsingGET(filterInvoice: Option[Integer] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageTransactionResource] = {
    // create path and map variables
