...
class StoreCouponsApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   * @return CouponItem
   */
  def createCouponItem(couponItem: Option[CouponItem] = None): Option[CouponItem] = {
   ...
   * @return void
   */
  def updateCouponItem(id: Integer, couponItem: Option[CouponItem] = None) = {
    // create path and map variables
    val path = "/store/coupons/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
   ...
   * @return void
   */
  def updateCouponTemplate(id: String, couponTemplateResource: Option[ItemTemplateResource] = None) = {
    // create path and map variables
    val path = "/store/coupons/templates/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
