...
class GamificationAchievementsApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getAchievementTemplatesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceTemplateResource] = {
    // create path and map variables
    val path = "/achievements/templates".replaceAll("\\{format\\}", "json")
   ...
   */
  def getAchievementsUsingGET(filterTagset: Option[String] = None, filterName: Option[String] = None, filterHidden: Option[Boolean] = None, filterDerived: Option[Boolean] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = name:ASC*/): Option[PageResourceAchievementDefinitionResource] = {
    // create path and map variables
    val path = "/achievements".replaceAll("\\{format\\}", "json")
   ...
   */
  def getAllUserProgressForAchievementUsingGET(achievementName: String, filterAchievementDerived: Option[Boolean] = None, filterAchievementTagset: Option[String] = None, filterAchievementHidden: Option[Boolean] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceUserAchievementGroupResource] = {
    // create path and map variables
   ...
   * @return PageResourceUserAchievementGroupResource
   */
  def getAllUserProgressUsingGET(filterAchievementDerived: Option[Boolean] = None, filterAchievementTagset: Option[String] = None, filterAchievementName: Option[String] = None, filterAchievementHidden: Option[Boolean] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceUserAchievementGroupResource] = {
    // create path and map variables
