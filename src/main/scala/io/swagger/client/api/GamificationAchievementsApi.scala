...
class GamificationAchievementsApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def getAchievementsUsingGET(filterTagset: Option[String] = None, filterName: Option[String] = None, filterHidden: Option[Boolean] = None, filterDerived: Option[Boolean] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageAchievementDefinitionResource] = {
    // create path and map variables
    val path = "/achievements".replaceAll("\\{format\\}", "json")
