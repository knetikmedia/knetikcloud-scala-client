...
class GamificationAchievementsApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getAchievements(filterTagset: Option[String] = None, filterName: Option[String] = None, filterHidden: Option[Boolean] = None, filterDerived: Option[Boolean] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = name:ASC*/): Option[PageResourceAchievementDefinitionResource] = {
    // create path and map variables
    val path = "/achievements".replaceAll("\\{format\\}", "json")
   ...
   */
  def getUserAchievementsProgress(userId: Integer, filterAchievementDerived: Option[Boolean] = None, filterAchievementTagset: Option[String] = None, filterAchievementName: Option[String] = None, filterAchievementHidden: Option[Boolean] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceUserAchievementGroupResource] = {
    // create path and map variables
   ...
   * @return PageResourceUserAchievementGroupResource
   */
  def getUsersAchievementProgress(achievementName: String, filterAchievementDerived: Option[Boolean] = None, filterAchievementTagset: Option[String] = None, filterAchievementHidden: Option[Boolean] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceUserAchievementGroupResource] = {
    // create path and map variables
   ...
   * @return PageResourceUserAchievementGroupResource
   */
  def getUsersAchievementsProgress(filterAchievementDerived: Option[Boolean] = None, filterAchievementTagset: Option[String] = None, filterAchievementName: Option[String] = None, filterAchievementHidden: Option[Boolean] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceUserAchievementGroupResource] = {
    // create path and map variables
   ...
   * @return void
   */
  def updateAchievement(name: String, achievement: Option[AchievementDefinitionResource] = None) = {
    // create path and map variables
    val path = "/achievements/{name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "name" + "\\}",apiInvoker.escape(name))
   ...
   * @return UserAchievementGroupResource
   */
  def updateAchievementProgress(userId: Integer, achievementName: String, request: Option[AchievementProgressUpdateRequest] = None): Option[UserAchievementGroupResource] = {
    // create path and map variables
    val path = "/users/{user_id}/achievements/{achievement_name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "user_id" + "\\}",apiInvoker.escape(userId)).replaceAll("\\{" + "achievement_name" + "\\}",apiInvoker.escape(achievementName))
    ...
    if (achievementName == null) throw new Exception("Missing required parameter 'achievementName' when calling GamificationAchievementsApi->updateAchievementProgress")
   ...
   * @return void
   */
  def updateAchievementTemplate(id: String, template: Option[TemplateResource] = None) = {
    // create path and map variables
    val path = "/achievements/templates/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
