...
import io.swagger.client.model.PageUserAchievementResource
...
class GamificationAchievementsApi(val defBasePath: String = "https://devsandbox.knetikcloud.com/",
   ...
   */
  def getAchievementTemplatesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageTemplateResource] = {
    // create path and map variables
    val path = "/achievements/templates".replaceAll("\\{format\\}", "json")
   ...
   */
  def getAchievementsUsingGET(filterTagset: Option[String] = None, filterName: Option[String] = None, filterHidden: Option[Boolean] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageAchievementDefinitionResource] = {
    // create path and map variables
    val path = "/achievements".replaceAll("\\{format\\}", "json")
   ...
   */
  def getAllUserProgressForAchievementUsingGET(achievementName: String, filterAchievementTagset: Option[String] = None, filterAchievementHidden: Option[Boolean] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageUserAchievementResource] = {
    // create path and map variables
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(ApiInvoker.deserialize(s, "", classOf[PageUserAchievementResource]).asInstanceOf[PageUserAchievementResource])
        case _ => None
      }
    } catch {
      case ex: ApiException if ex.code == 404 => None
   ...
   * @return PageUserAchievementResource
   */
  def getAllUserProgressUsingGET(filterAchievementTagset: Option[String] = None, filterAchievementName: Option[String] = None, filterAchievementHidden: Option[Boolean] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageUserAchievementResource] = {
    // create path and map variables
   ...
   */
  def getUserProgressForAchievementUsingGET(userId: Integer, achievementName: String): Option[UserAchievementResource] = {
    // create path and map variables
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(ApiInvoker.deserialize(s, "", classOf[UserAchievementResource]).asInstanceOf[UserAchievementResource])
        case _ => None
      }
    } catch {
      case ex: ApiException if ex.code == 404 => None
   ...
   * @return PageUserAchievementResource
   */
  def getUserProgressUsingGET(userId: Integer, filterAchievementTagset: Option[String] = None, filterAchievementName: Option[String] = None, filterAchievementHidden: Option[Boolean] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageUserAchievementResource] = {
    // create path and map variables
   ...
   * @return UserAchievementResource
   */
  def updateProgressUsingPUT(userId: Integer, achievementName: String, request: Option[AchievementProgressUpdateRequest] = None): Option[UserAchievementResource] = {
    // create path and map variables
    val path = "/users/{user_id}/achievements/{achievement_name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "user_id" + "\\}",apiInvoker.escape(userId)).replaceAll("\\{" + "achievement_name" + "\\}",apiInvoker.escape(achievementName))
