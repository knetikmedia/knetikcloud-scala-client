...
class DispositionsApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getDispositionsUsingGET(filterContext: Option[String] = None, filterOwner: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceDispositionResource] = {
    // create path and map variables
    val path = "/dispositions".replaceAll("\\{format\\}", "json")
