...
class ContentArticlesApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def getArticleTemplatesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageTemplateResource] = {
    // create path and map variables
    val path = "/content/articles/templates".replaceAll("\\{format\\}", "json")
   ...
   */
  def getArticlesUsingGET(filterCategory: Option[String] = None, filterTagset: Option[String] = None, filterTitle: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageArticleResource] = {
    // create path and map variables
    val path = "/content/articles".replaceAll("\\{format\\}", "json")
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(ApiInvoker.deserialize(s, "", classOf[PageArticleResource]).asInstanceOf[PageArticleResource])
        case _ => None
      }
    } catch {
      case ex: ApiException if ex.code == 404 => None
