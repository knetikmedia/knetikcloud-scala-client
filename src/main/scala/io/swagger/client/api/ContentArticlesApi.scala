...
class ContentArticlesApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def getArticleTemplatesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageTemplateResource] = {
    // create path and map variables
    val path = "/content/articles/templates".replaceAll("\\{format\\}", "json")
   ...
   */
  def getArticlesUsingGET(filterCategory: Option[String] = None, filterTagset: Option[String] = None, filterTitle: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageArticleResource] = {
    // create path and map variables
    val path = "/content/articles".replaceAll("\\{format\\}", "json")
