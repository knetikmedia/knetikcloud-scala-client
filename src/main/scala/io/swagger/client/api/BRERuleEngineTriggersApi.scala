...
class BRERuleEngineTriggersApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   * @return void
   */
  def updateBRETrigger(eventName: String, breTriggerResource: Option[BreTriggerResource] = None) = {
    // create path and map variables
    val path = "/bre/triggers/{event_name}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "event_name" + "\\}",apiInvoker.escape(eventName))
