...
class MediaVideosApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def addCommentUsingPOST1(videoId: Integer, commentResource: Option[CommentResource] = None): Option[CommentResource] = {
   ...
   * @return void
   */
  def addContributorUsingPOST(videoId: Long, contributionResource: Option[ContributionResource] = None) = {
    // create path and map variables
   ...
   */
  def addDispositionUsingPOST1(videoId: Integer, dispositionResource: Option[DispositionResource] = None): Option[DispositionResource] = {
    // create path and map variables
   ...
   * @return void
   */
  def addFlagUsingPOST(videoId: Long, reason: Option[String] = None) = {
    // create path and map variables
   ...
   */
  def addRelatedUsingPOST(videoId: Long, videoRelationshipResource: Option[VideoRelationshipResource] = None): Option[VideoRelationshipResource] = {
    // create path and map variables
   ...
   */
  def addVideoUsingPOST(videoResource: Option[VideoResource] = None): Option[VideoResource] = {
    // create path and map variables
   ...
   * @return void
   */
  def addWhitelistUsingPOST(id: Long, userId: Option[Integer] = None) = {
    // create path and map variables
   ...
   * @return void
   */
  def deleteCommentUsingDELETE1(videoId: Long, id: Long) = {
    // create path and map variables
   ...
   * @return void
   */
  def deleteDispositionUsingDELETE1(dispositionId: Long) = {
    // create path and map variables
   ...
   * @return void
   */
  def deleteFlagUsingDELETE(videoId: Long) = {
    // create path and map variables
    val path = "/media/videos/{video_id}/moderation".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "video_id" + "\\}",apiInvoker.escape(videoId))
   ...
   * @return void
   */
  def deleteRelationshipUsingDELETE1(videoId: Long, id: Long) = {
    // create path and map variables
   ...
   * @return void
   */
  def deleteVideoUsingDELETE(id: Long) = {
    // create path and map variables
   ...
   */
  def getCommentsUsingGET1(videoId: Integer, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageCommentResource] = {
    // create path and map variables
    val path = "/media/videos/{video_id}/comments".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "video_id" + "\\}",apiInvoker.escape(videoId))
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(ApiInvoker.deserialize(s, "", classOf[PageCommentResource]).asInstanceOf[PageCommentResource])
        case _ => None
      }
    } catch {
      case ex: ApiException if ex.code == 404 => None
   ...
   */
  def getDispositionsUsingGET1(videoId: Integer, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageDispositionResource] = {
    // create path and map variables
    val path = "/media/videos/{video_id}/dispositions".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "video_id" + "\\}",apiInvoker.escape(videoId))
   ...
   */
  def getRelatedUsingGET(videoId: Long, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageVideoRelationshipResource] = {
    // create path and map variables
    val path = "/media/videos/{video_id}/related".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "video_id" + "\\}",apiInvoker.escape(videoId))
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(ApiInvoker.deserialize(s, "", classOf[PageVideoRelationshipResource]).asInstanceOf[PageVideoRelationshipResource])
        case _ => None
      }
    } catch {
      case ex: ApiException if ex.code == 404 => None
   ...
   */
  def getUserVideosUsingGET(userId: Integer, excludeFlagged: Option[Boolean] /* = true*/, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageVideoResource] = {
    // create path and map variables
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(ApiInvoker.deserialize(s, "", classOf[PageVideoResource]).asInstanceOf[PageVideoResource])
        case _ => None
      }
    } catch {
      case ex: ApiException if ex.code == 404 => None
   ...
   * @return VideoResource
   */
  def getVideoUsingGET(id: Long): Option[VideoResource] = {
    // create path and map variables
    val path = "/media/videos/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
   ...
   * @return void
   */
  def removeContributorUsingDELETE(videoId: Long, id: Integer) = {
    // create path and map variables
   ...
   * @return void
   */
  def removeWhitelistUsingDELETE(videoId: Long, id: Integer) = {
    // create path and map variables
   ...
   * @return void
   */
  def updateCommentUsingPUT1(videoId: Long, id: Long, content: Option[String] = None) = {
    // create path and map variables
   ...
   * @return void
   */
  def updateRelationshipUsingPUT1(videoId: Long, relationshipId: Long, details: Option[String] = None) = {
    // create path and map variables
   ...
   * @return void
   */
  def updateVideoUsingPUT(id: Long, videoResource: Option[VideoResource] = None) = {
    // create path and map variables
    val path = "/media/videos/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
   ...
   * @return void
   */
  def viewVideoUsingPOST(id: Long) = {
    // create path and map variables
