...
class MediaVideosApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getCommentsUsingGET1(videoId: Integer, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceCommentResource] = {
    // create path and map variables
    val path = "/media/videos/{video_id}/comments".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "video_id" + "\\}",apiInvoker.escape(videoId))
   ...
   */
  def getDispositionsUsingGET1(videoId: Integer, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceDispositionResource] = {
    // create path and map variables
    val path = "/media/videos/{video_id}/dispositions".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "video_id" + "\\}",apiInvoker.escape(videoId))
   ...
   */
  def getRelatedUsingGET(videoId: Long, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceVideoRelationshipResource] = {
    // create path and map variables
    val path = "/media/videos/{video_id}/related".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "video_id" + "\\}",apiInvoker.escape(videoId))
   ...
   */
  def getUserVideosUsingGET(userId: Integer, excludeFlagged: Option[Boolean] /* = true*/, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceVideoResource] = {
    // create path and map variables
