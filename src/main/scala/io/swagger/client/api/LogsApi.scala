...
class LogsApi(val defBasePath: String = "https://localhost:8080/",
   ...
   * @return void
   */
  def addUserLogUsingPOST(logEntry: Option[UserActionLog] = None) = {
   ...
   * @return BreEventLog
   */
  def getEventLogUsingGET(id: String): Option[BreEventLog] = {
    // create path and map variables
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling LogsApi->getEventLogUsingGET")
   ...
   */
  def getEventsLogsUsingGET(filterStartDate: Option[String] = None, filterEventName: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:DESC*/): Option[PageBreEventLog] = {
    // create path and map variables
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(ApiInvoker.deserialize(s, "", classOf[PageBreEventLog]).asInstanceOf[PageBreEventLog])
        case _ => None
      }
    } catch {
      case ex: ApiException if ex.code == 404 => None
   ...
   * @return ForwardLog
   */
  def getForwardLogUsingGET(id: String): Option[ForwardLog] = {
    // create path and map variables
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling LogsApi->getForwardLogUsingGET")
   ...
   */
  def getForwardLogsUsingGET(filterStartDate: Option[String] = None, filterEndDate: Option[String] = None, filterStatusCode: Option[Integer] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:DESC*/): Option[PageForwardLog] = {
    // create path and map variables
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(ApiInvoker.deserialize(s, "", classOf[PageForwardLog]).asInstanceOf[PageForwardLog])
        case _ => None
      }
    } catch {
      case ex: ApiException if ex.code == 404 => None
   ...
   */
  def getUserLogsUsingGET(id: String): Option[UserActionLog] = {
    // create path and map variables
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling LogsApi->getUserLogsUsingGET")
   ...
   */
  def getUserLogsUsingGET1(filterUser: Option[Integer] = None, filterActionName: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageUserActionLog] = {
    // create path and map variables
    val path = "/audit/logs".replaceAll("\\{format\\}", "json")
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(ApiInvoker.deserialize(s, "", classOf[PageUserActionLog]).asInstanceOf[PageUserActionLog])
        case _ => None
      }
    } catch {
      case ex: ApiException if ex.code == 404 => None
