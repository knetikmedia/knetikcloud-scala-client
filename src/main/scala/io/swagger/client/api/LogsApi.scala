...
class LogsApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def getEventsLogsUsingGET(filterStartDate: Option[String] = None, filterEventName: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageBreEventLog] = {
    // create path and map variables
   ...
   */
  def getForwardLogsUsingGET(filterStartDate: Option[String] = None, filterEndDate: Option[String] = None, filterStatusCode: Option[Integer] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageForwardLog] = {
    // create path and map variables
