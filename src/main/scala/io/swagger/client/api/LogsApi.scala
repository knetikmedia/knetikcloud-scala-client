...
class LogsApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getEventsLogsUsingGET(filterStartDate: Option[String] = None, filterEventName: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:DESC*/): Option[PageResourceBreEventLog] = {
    // create path and map variables
   ...
   */
  def getForwardLogsUsingGET(filterStartDate: Option[String] = None, filterEndDate: Option[String] = None, filterStatusCode: Option[Integer] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:DESC*/): Option[PageResourceForwardLog] = {
    // create path and map variables
   ...
   */
  def getUserLogsUsingGET1(filterUser: Option[Integer] = None, filterActionName: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceUserActionLog] = {
    // create path and map variables
    val path = "/audit/logs".replaceAll("\\{format\\}", "json")
