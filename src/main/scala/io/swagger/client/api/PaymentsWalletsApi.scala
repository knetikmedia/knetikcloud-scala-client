...
class PaymentsWalletsApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def getWalletsUsingGET1(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageSimpleWallet] = {
    // create path and map variables
   ...
   * @return PageWalletTransactionResource
   */
  def userTransactionHistoryUsingGET(userId: Integer, currencyCode: String, filterType: Option[String] = None, filterMaxDate: Option[Long] = None, filterMinDate: Option[Long] = None, filterSign: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageWalletTransactionResource] = {
    // create path and map variables
