...
class PaymentsWalletsApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   * @return PageResourceWalletTransactionResource
   */
  def getWalletTransactions(filterInvoice: Option[Integer] = None, filterType: Option[String] = None, filterMaxDate: Option[Long] = None, filterMinDate: Option[Long] = None, filterSign: Option[String] = None, filterUserId: Option[Integer] = None, filterUsername: Option[String] = None, filterDetails: Option[String] = None, filterCurrencyCode: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceWalletTransactionResource] = {
    // create path and map variables
