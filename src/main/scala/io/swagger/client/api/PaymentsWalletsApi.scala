...
class PaymentsWalletsApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getWalletTotalsUsingGET(): Option[PageResourceWalletTotalResponse] = {
   ...
   */
  def getWalletsUsingGET1(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceSimpleWallet] = {
    // create path and map variables
