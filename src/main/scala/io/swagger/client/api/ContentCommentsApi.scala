...
class ContentCommentsApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getCommentsUsingGET(context: String, contextId: Integer, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceCommentResource] = {
    // create path and map variables
    val path = "/comments".replaceAll("\\{format\\}", "json")
