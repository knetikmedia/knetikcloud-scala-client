...
class ContentCommentsApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def addCommentUsingPOST(commentResource: Option[CommentResource] = None): Option[CommentResource] = {
   ...
   * @return void
   */
  def deleteCommentUsingDELETE(id: Long) = {
    // create path and map variables
   ...
   * @return CommentResource
   */
  def getCommentUsingGET(id: Long): Option[CommentResource] = {
    // create path and map variables
    val path = "/comments/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
   ...
   */
  def getCommentsUsingGET(context: String, contextId: Integer, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageCommentResource] = {
    // create path and map variables
    val path = "/comments".replaceAll("\\{format\\}", "json")
    ...
    if (context == null) throw new Exception("Missing required parameter 'context' when calling ContentCommentsApi->getCommentsUsingGET")
   ...
   */
  def searchCommentsUsingPOST(query: Option[Any] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[CommentSearch] = {
    // create path and map variables
   ...
   * @return void
   */
  def updateCommentUsingPUT(id: Long, content: Option[String] = None) = {
    // create path and map variables
