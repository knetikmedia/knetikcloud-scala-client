...
class StoreShoppingCartsApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def searchCartsUsingGET(filterOwnerId: Option[Integer] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageCartSummary] = {
    // create path and map variables
    val path = "/carts".replaceAll("\\{format\\}", "json")
