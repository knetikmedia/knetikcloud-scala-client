...
class StoreShoppingCartsApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def getCountries(id: String): Option[SampleCountriesResponse] = {
    // create path and map variables
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling StoreShoppingCartsApi->getCountries")
