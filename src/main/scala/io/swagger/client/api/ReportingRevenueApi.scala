...
class ReportingRevenueApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def executiveRevenueCountrySalesUsingGET(currencyCode: String, startDate: Option[Long] = None, endDate: Option[Long] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceRevenueCountryReportResource] = {
   ...
   */
  def executiveRevenueProductSalesUsingGET(currencyCode: String, startDate: Option[Long] = None, endDate: Option[Long] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceRevenueProductReportResource] = {
    // create path and map variables
