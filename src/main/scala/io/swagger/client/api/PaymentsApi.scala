...
class PaymentsApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def createPaymentMethodUsingPOST(userId: Integer, paymentMethod: Option[PaymentMethodResource] = None): Option[PaymentMethodResource] = {
   ...
   * @return void
   */
  def deletePaymentMethodUsingDELETE(userId: Integer, id: Integer) = {
    // create path and map variables
   ...
   * @return PaymentMethodResource
   */
  def getPaymentMethodUsingGET(userId: Integer, id: Integer): Option[PaymentMethodResource] = {
    // create path and map variables
    val path = "/users/{user_id}/payment-methods/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "user_id" + "\\}",apiInvoker.escape(userId)).replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
   ...
   */
  def getPaymentMethodsUsingGET(userId: Integer, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[List[PaymentMethodResource]] = {
    // create path and map variables
    val path = "/users/{user_id}/payment-methods".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "user_id" + "\\}",apiInvoker.escape(userId))
   ...
   */
  def paymentAuthorizationUsingPOST(request: Option[PaymentAuthorizationResource] = None): Option[PaymentAuthorizationResource] = {
    // create path and map variables
   ...
   * @return void
   */
  def paymentCaptureUsingPOST(id: Integer) = {
    // create path and map variables
   ...
   * @return void
   */
  def updatePaymentMethodUsingPUT(userId: Integer, id: Integer, paymentMethod: Option[PaymentMethodResource] = None) = {
    // create path and map variables
    val path = "/users/{user_id}/payment-methods/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "user_id" + "\\}",apiInvoker.escape(userId)).replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
