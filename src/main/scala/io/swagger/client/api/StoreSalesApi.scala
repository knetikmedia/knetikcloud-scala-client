...
class StoreSalesApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getCatalogSalesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceCatalogSale] = {
    // create path and map variables
    val path = "/store/sales".replaceAll("\\{format\\}", "json")
