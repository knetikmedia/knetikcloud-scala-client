...
class InvoicesApi(val defBasePath: String = "https://devsandbox.knetikcloud.com/",
   ...
   * @param filterCreatedDate Filters invoices by creation date. Multiple values possible for range search. Format: filter_date_created&#x3D;OP,ts&amp;... where OP in (GT, LT, GOE, LOE, EQ) and ts is a unix timestamp in seconds. Ex: filter_date_created&#x3D;GT,1452154258&amp;filter_date_created&#x3D;LT,1554254874 (optional)
   ...
   */
  def getInvoiceHistoryUsingGET(filterUser: Option[Integer] = None, filterEmail: Option[String] = None, filterFulfillmentStatus: Option[String] = None, filterPaymentStatus: Option[String] = None, filterItemName: Option[String] = None, filterCreatedDate: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageInvoiceResource] = {
    // create path and map variables
    val path = "/invoices".replaceAll("\\{format\\}", "json")
