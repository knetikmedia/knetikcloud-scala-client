...
class InvoicesApi(val defBasePath: String = "https://sandbox.knetikcloud.com",
   ...
   * @param filterShipping Filters invoices by shipping price (optional)
