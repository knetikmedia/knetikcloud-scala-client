...
class InvoicesApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getInvoices(filterUser: Option[Integer] = None, filterEmail: Option[String] = None, filterFulfillmentStatus: Option[String] = None, filterPaymentStatus: Option[String] = None, filterItemName: Option[String] = None, filterExternalRef: Option[String] = None, filterCreatedDate: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageResourceInvoiceResource] = {
    // create path and map variables
    val path = "/invoices".replaceAll("\\{format\\}", "json")
