...
class StoreSubscriptionsApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getSubscriptionTemplatesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceSubscriptionTemplateResource] = {
    // create path and map variables
    val path = "/subscriptions/templates".replaceAll("\\{format\\}", "json")
   ...
   */
  def listSubscriptionsUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceSubscriptionResource] = {
    // create path and map variables
    val path = "/subscriptions".replaceAll("\\{format\\}", "json")
