...
class ReportingSubscriptionsApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def listBillingReportsUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceBillingReport] = {
