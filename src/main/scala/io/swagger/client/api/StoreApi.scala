...
class StoreApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getItemTemplatesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceStoreItemTemplateResource] = {
    // create path and map variables
    val path = "/store/items/templates".replaceAll("\\{format\\}", "json")
   ...
   * @return PageResourceStoreItem
   */
  def getUsingGET2(limit: Option[Integer] = None, page: Option[Integer] = None, useCatalog: Option[Boolean] = None, ignoreLocation: Option[Boolean] = None, inStockOnly: Option[Boolean] /* = false*/): Option[PageResourceStoreItem] = {
    // create path and map variables
