...
class StoreApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   * @return StoreItem
   */
  def createStoreItem(storeItem: Option[StoreItem] = None): Option[StoreItem] = {
    // create path and map variables
   ...
   * @return void
   */
  def updateItemTemplate(id: String, itemTemplateResource: Option[StoreItemTemplateResource] = None) = {
    // create path and map variables
    val path = "/store/items/templates/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
   ...
   * @return void
   */
  def updateStoreItem(id: Integer, storeItem: Option[StoreItem] = None) = {
    // create path and map variables
    val path = "/store/items/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
