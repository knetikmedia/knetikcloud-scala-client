...
class StoreVendorsApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def getVendorsUsingGET(filterName: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageVendorResource] = {
    // create path and map variables
    val path = "/vendors".replaceAll("\\{format\\}", "json")
