...
class StoreVendorsApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getVendorsUsingGET(filterName: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceVendorResource] = {
    // create path and map variables
    val path = "/vendors".replaceAll("\\{format\\}", "json")
