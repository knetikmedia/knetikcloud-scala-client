...
class BRERuleEngineRulesApi(val defBasePath: String = "https://localhost:8080/",
   ...
   * @return String
   */
  def convertExpressionToStringUsingPOST(expression: Option[Expressionobject] = None): Option[String] = {
   ...
   * @return BreRule
   */
  def createRuleUsingPOST(breRule: Option[BreRule] = None): Option[BreRule] = {
    // create path and map variables
   ...
   * @return void
   */
  def deleteRuleUsingDELETE(id: String) = {
    // create path and map variables
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling BRERuleEngineRulesApi->deleteRuleUsingDELETE")
   ...
   * @return void
   */
  def enableRuleUsingPUT(id: String, enabled: Option[BooleanResource] = None) = {
    // create path and map variables
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling BRERuleEngineRulesApi->enableRuleUsingPUT")
   ...
   * @return BreRule
   */
  def getRuleUsingGET(id: String): Option[BreRule] = {
    // create path and map variables
    val path = "/bre/rules/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling BRERuleEngineRulesApi->getRuleUsingGET")
   ...
   * @return PageBreRule
   */
  def getRulesUsingGET(filterName: Option[String] = None, filterEnabled: Option[Boolean] /* = null*/, filterSystem: Option[Boolean] = None, filterTrigger: Option[String] = None, filterAction: Option[String] = None, filterCondition: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageBreRule] = {
    // create path and map variables
    val path = "/bre/rules".replaceAll("\\{format\\}", "json")
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(ApiInvoker.deserialize(s, "", classOf[PageBreRule]).asInstanceOf[PageBreRule])
        case _ => None
      }
    } catch {
      case ex: ApiException if ex.code == 404 => None
   ...
   * @return void
   */
  def updateRuleUsingPUT(id: String, breRule: Option[BreRule] = None) = {
    // create path and map variables
    val path = "/bre/rules/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling BRERuleEngineRulesApi->updateRuleUsingPUT")
