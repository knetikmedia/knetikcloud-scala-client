...
class BRERuleEngineRulesApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getRulesUsingGET(filterName: Option[String] = None, filterEnabled: Option[Boolean] /* = null*/, filterSystem: Option[Boolean] = None, filterTrigger: Option[String] = None, filterAction: Option[String] = None, filterCondition: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceBreRule] = {
    // create path and map variables
    val path = "/bre/rules".replaceAll("\\{format\\}", "json")
