...
class UsersApi(val defBasePath: String = "https://devsandbox.knetikcloud.com/",
   ...
   */
  def getUserTemplatesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageTemplateResource] = {
    // create path and map variables
    val path = "/users/templates".replaceAll("\\{format\\}", "json")
