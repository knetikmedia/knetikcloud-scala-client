...
class UsersApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getUserTemplatesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceTemplateResource] = {
    // create path and map variables
    val path = "/users/templates".replaceAll("\\{format\\}", "json")
   ...
   */
  def getUsersUsingGET(filterDisplayname: Option[String] = None, filterEmail: Option[String] = None, filterFirstname: Option[String] = None, filterFullname: Option[String] = None, filterLastname: Option[String] = None, filterUsername: Option[String] = None, filterTag: Option[String] = None, filterGroup: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceUserBaseResource] = {
    // create path and map variables
