...
class DevicesApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getDevicesUsingGET(filterMake: Option[String] = None, filterModel: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceDeviceResource] = {
    // create path and map variables
    val path = "/devices".replaceAll("\\{format\\}", "json")
