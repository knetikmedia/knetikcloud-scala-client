...
class StoreShippingApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   * @return ShippingItem
   */
  def createShippingItem(shippingItem: Option[ShippingItem] = None): Option[ShippingItem] = {
   ...
   * @return void
   */
  def updateShippingItem(id: Integer, shippingItem: Option[ShippingItem] = None) = {
    // create path and map variables
    val path = "/store/shipping/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
   ...
   * @return void
   */
  def updateShippingTemplate(id: String, shippingTemplateResource: Option[ItemTemplateResource] = None) = {
    // create path and map variables
    val path = "/store/shipping/templates/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
