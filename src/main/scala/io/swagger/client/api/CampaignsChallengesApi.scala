...
class CampaignsChallengesApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getActivitiesUsingGET1(challengeId: Long, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceBareChallengeActivityResource] = {
    // create path and map variables
    val path = "/challenges/{challenge_id}/activities".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "challenge_id" + "\\}",apiInvoker.escape(challengeId))
   ...
   */
  def getChallengeEventssUsingGET(filterStartDate: Option[String] = None, filterEndDate: Option[String] = None, filterCampaigns: Option[Boolean] = None, filterChallenge: Option[Long] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceChallengeEventResource] = {
    // create path and map variables
   ...
   */
  def getChallengeTemplatesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceTemplateResource] = {
    // create path and map variables
    val path = "/challenges/templates".replaceAll("\\{format\\}", "json")
   ...
   */
  def getChallengesUsingGET1(filterTemplate: Option[Boolean] = None, filterActiveCampaign: Option[Boolean] = None): Option[PageResourceChallengeResource] = {
    // create path and map variables
    val path = "/challenges".replaceAll("\\{format\\}", "json")
