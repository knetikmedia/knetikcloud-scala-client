...
class CampaignsChallengesApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def getChallengeEventssUsingGET(filterStartDate: Option[String] = None, filterEndDate: Option[String] = None, filterCampaigns: Option[Boolean] = None, filterChallenge: Option[Long] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageChallengeEventResource] = {
    // create path and map variables
