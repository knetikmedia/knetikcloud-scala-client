...
class CampaignsChallengesApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   * @return void
   */
  def updateChallengeActivity(activityId: Long, challengeId: Long, challengeActivityResource: Option[ChallengeActivityResource] = None) = {
    // create path and map variables
    val path = "/challenges/{challenge_id}/activities/{activity_id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "activity_id" + "\\}",apiInvoker.escape(activityId)).replaceAll("\\{" + "challenge_id" + "\\}",apiInvoker.escape(challengeId))
   ...
   * @return void
   */
  def updateChallengeTemplate(id: String, challengeTemplateResource: Option[TemplateResource] = None) = {
    // create path and map variables
    val path = "/challenges/templates/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
