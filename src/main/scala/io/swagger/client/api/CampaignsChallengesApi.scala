...
class CampaignsChallengesApi(val defBasePath: String = "https://devsandbox.knetikcloud.com/",
   ...
   */
  def createChallengeActivityUsingPOST(challengeId: Long, challengeActivityResource: Option[ChallengeActivityResource] = None, validateSettings: Option[Boolean] /* = false*/): Option[ChallengeActivityResource] = {
   ...
   */
  def createChallengeTemplateUsingPOST(challengeTemplateResource: Option[TemplateResource] = None): Option[TemplateResource] = {
    // create path and map variables
   ...
   */
  def createChallengeUsingPOST(challengeResource: Option[ChallengeResource] = None): Option[ChallengeResource] = {
    // create path and map variables
   ...
   * @return void
   */
  def deleteChallengeActivityUsingDELETE(activityId: Long, challengeId: Long) = {
    // create path and map variables
   ...
   * @return void
   */
  def deleteChallengeEventUsingDELETE(id: Long) = {
    // create path and map variables
   ...
   * @return void
   */
  def deleteChallengeTemplateUsingDELETE(id: String, cascade: Option[String] = None) = {
    // create path and map variables
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling CampaignsChallengesApi->deleteChallengeTemplateUsingDELETE")
   ...
   * @return void
   */
  def deleteChallengeUsingDELETE(id: Long) = {
    // create path and map variables
   ...
   */
  def getActivitiesUsingGET1(challengeId: Long, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageBareChallengeActivityResource] = {
    // create path and map variables
    val path = "/challenges/{challenge_id}/activities".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "challenge_id" + "\\}",apiInvoker.escape(challengeId))
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(ApiInvoker.deserialize(s, "", classOf[PageBareChallengeActivityResource]).asInstanceOf[PageBareChallengeActivityResource])
        case _ => None
      }
    } catch {
      case ex: ApiException if ex.code == 404 => None
   ...
   * @return ChallengeActivityResource
   */
  def getChallengeActivityUsingGET(activityId: Long): Option[ChallengeActivityResource] = {
    // create path and map variables
   ...
   */
  def getChallengeEventUsingGET(id: Long): Option[ChallengeEventResource] = {
    // create path and map variables
    val path = "/challenges/events/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
   ...
   */
  def getChallengeEventssUsingGET(filterStartDateMin: Option[Long] = None, filterStartDateMax: Option[Long] = None, filterEndDateMin: Option[Long] = None, filterEndDateMax: Option[Long] = None, filterCampaigns: Option[Boolean] = None, filterChallenge: Option[Long] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageChallengeEventResource] = {
    // create path and map variables
    ...
    filterStartDateMin.map(paramVal => queryParams += "filter_start_date_min" -> paramVal.toString)
    filterStartDateMax.map(paramVal => queryParams += "filter_start_date_max" -> paramVal.toString)
    filterEndDateMin.map(paramVal => queryParams += "filter_end_date_min" -> paramVal.toString)
    filterEndDateMax.map(paramVal => queryParams += "filter_end_date_max" -> paramVal.toString)
    ...
    try {
      apiInvoker.invokeApi(basePath, path, "GET", queryParams.toMap, formParams.toMap, postBody, headerParams.toMap, contentType) match {
        case s: String =>
           Some(ApiInvoker.deserialize(s, "", classOf[PageChallengeEventResource]).asInstanceOf[PageChallengeEventResource])
        case _ => None
      }
    } catch {
      case ex: ApiException if ex.code == 404 => None
   ...
   * @return TemplateResource
   */
  def getChallengeTemplateUsingGET(id: String): Option[TemplateResource] = {
    // create path and map variables
    val path = "/challenges/templates/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling CampaignsChallengesApi->getChallengeTemplateUsingGET")
   ...
   */
  def getChallengeTemplatesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = 1*/): Option[PageTemplateResource] = {
    // create path and map variables
    val path = "/challenges/templates".replaceAll("\\{format\\}", "json")
   ...
   * @return ChallengeResource
   */
  def getChallengeUsingGET(id: Long): Option[ChallengeResource] = {
    // create path and map variables
    val path = "/challenges/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
   ...
   */
  def getChallengesUsingGET1(filterTemplate: Option[Boolean] = None, filterActiveCampaign: Option[Boolean] = None): Option[PageChallengeResource] = {
    // create path and map variables
    val path = "/challenges".replaceAll("\\{format\\}", "json")
   ...
   * @return void
   */
  def updateChallengeActivityUsingPUT(activityId: Long, challengeId: Long, challengeActivityResource: Option[ChallengeActivityResource] = None) = {
    // create path and map variables
    val path = "/challenges/{challenge_id}/activities/{activity_id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "activity_id" + "\\}",apiInvoker.escape(activityId)).replaceAll("\\{" + "challenge_id" + "\\}",apiInvoker.escape(challengeId))
   ...
   * @return void
   */
  def updateChallengeTemplateUsingPUT(id: String, challengeTemplateResource: Option[TemplateResource] = None) = {
    // create path and map variables
    val path = "/challenges/templates/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling CampaignsChallengesApi->updateChallengeTemplateUsingPUT")
   ...
   * @return ChallengeResource
   */
  def updateChallengeUsingPUT(id: Long, challengeResource: Option[ChallengeResource] = None): Option[ChallengeResource] = {
    // create path and map variables
    val path = "/challenges/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
