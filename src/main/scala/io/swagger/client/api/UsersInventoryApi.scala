...
class UsersInventoryApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def getUserInventory1(id: Integer, inactive: Option[Boolean] /* = false*/, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, filterItemName: Option[String] = None, filterMinDate: Option[Long] = None, filterMaxDate: Option[Long] = None): Option[PageResourceUserInventoryResource] = {
    // create path and map variables
    val path = "/users/{id}/inventory".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
   ...
   * @return void
   */
  def getUserInventoryLog1(userId: Integer, id: Integer, timestamp: Option[Long] = None) = {
    // create path and map variables
