...
class UsersInventoryApi(val defBasePath: String = "https://devsandbox.knetikcloud.com/",
   ...
   */
  def getInventoryListUsingGET(inactive: Option[Boolean] /* = false*/, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, filterItemName: Option[String] = None, filterMinDate: Option[Long] = None, filterMaxDate: Option[Long] = None): Option[PageUserInventoryResource] = {
    // create path and map variables
