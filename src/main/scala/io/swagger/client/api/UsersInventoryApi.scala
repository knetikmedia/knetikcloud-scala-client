...
class UsersInventoryApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getCurrenciesUsingGET1(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceEntitlementItem] = {
    // create path and map variables
    val path = "/entitlements".replaceAll("\\{format\\}", "json")
   ...
   */
  def getEntitlementTemplatesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceItemTemplateResource] = {
    // create path and map variables
    val path = "/entitlements/templates".replaceAll("\\{format\\}", "json")
   ...
   */
  def getInventoryListUsingGET(inactive: Option[Boolean] /* = false*/, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, filterItemName: Option[String] = None, filterUsername: Option[String] = None, filterGroup: Option[String] = None, filterDate: Option[String] = None): Option[PageResourceUserInventoryResource] = {
    // create path and map variables
   ...
   * @return PageResourceUserInventoryResource
   */
  def getUserInventoryListUsingGET(id: Integer, inactive: Option[Boolean] /* = false*/, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, filterItemName: Option[String] = None, filterMinDate: Option[Long] = None, filterMaxDate: Option[Long] = None): Option[PageResourceUserInventoryResource] = {
    // create path and map variables
    val path = "/users/{id}/inventory".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
   ...
   */
  def getUserInventoryLogUsingGET(userId: String, id: Integer, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceUserItemLogResource] = {
    // create path and map variables
   ...
   * @return void
   */
  def grantEntitlementUsingPOST(userId: Integer, grantRequest: EntitlementGrantRequest) = {
    // create path and map variables
    ...
    if (grantRequest == null) throw new Exception("Missing required parameter 'grantRequest' when calling UsersInventoryApi->grantEntitlementUsingPOST")
