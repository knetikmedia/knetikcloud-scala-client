...
class UsersInventoryApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def getCurrenciesUsingGET1(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageEntitlementItem] = {
    // create path and map variables
    val path = "/entitlements".replaceAll("\\{format\\}", "json")
   ...
   */
  def getEntitlementTemplatesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageItemTemplateResource] = {
    // create path and map variables
    val path = "/entitlements/templates".replaceAll("\\{format\\}", "json")
