...
class GamificationTriviaApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def getQuestionTags1(filterSearch: Option[String] = None, filterCategory: Option[String] = None, filterImportId: Option[Long] = None): Option[Collectionstring] = {
    // create path and map variables
   ...
   */
  def getQuestions(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/, filterSearch: Option[String] = None, filterIdset: Option[String] = None, filterCategory: Option[String] = None, filterTagset: Option[String] = None, filterType: Option[String] = None, filterPublished: Option[Boolean] = None, filterImportId: Option[Long] = None): Option[PageResourceQuestionResource] = {
    // create path and map variables
    val path = "/trivia/questions".replaceAll("\\{format\\}", "json")
   ...
   * @return void
   */
  def updateQuestionTemplate(id: String, questionTemplateResource: Option[QuestionTemplateResource] = None) = {
    // create path and map variables
    val path = "/trivia/questions/templates/{id}".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "id" + "\\}",apiInvoker.escape(id))
