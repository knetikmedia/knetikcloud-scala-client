...
class GamificationTriviaApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getListUsingGET1(filterVendor: Option[String] = None, filterCategory: Option[String] = None, filterName: Option[String] = None, filterStatus: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceImportJobResource] = {
    // create path and map variables
    val path = "/trivia/import".replaceAll("\\{format\\}", "json")
   ...
   */
  def getQuestionTemplatesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceQuestionTemplateResource] = {
    // create path and map variables
    val path = "/trivia/questions/templates".replaceAll("\\{format\\}", "json")
   ...
   */
  def getQuestionsUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/, filterSearch: Option[String] = None, filterIdset: Option[String] = None, filterCategory: Option[String] = None, filterTagset: Option[String] = None, filterType: Option[String] = None, filterPublished: Option[Boolean] = None, filterImportId: Option[Long] = None): Option[PageResourceQuestionResource] = {
    // create path and map variables
    val path = "/trivia/questions".replaceAll("\\{format\\}", "json")
