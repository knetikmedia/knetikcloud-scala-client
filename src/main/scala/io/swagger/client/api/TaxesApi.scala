...
class TaxesApi(val defBasePath: String = "https://localhost:8080/",
   ...
   */
  def getAllTaxesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = name:ASC*/): Option[PageStateTaxResource] = {
    // create path and map variables
   ...
   */
  def getTaxesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = name:ASC*/): Option[PageCountryTaxResource] = {
    // create path and map variables
   ...
   * @return PageStateTaxResource
   */
  def getTaxesUsingGET1(countryCodeIso3: String, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = name:ASC*/): Option[PageStateTaxResource] = {
    // create path and map variables
    val path = "/tax/countries/{country_code_iso3}/states".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "country_code_iso3" + "\\}",apiInvoker.escape(countryCodeIso3))
