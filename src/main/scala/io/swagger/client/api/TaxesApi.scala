...
class TaxesApi(val defBasePath: String = "https://integration.knetikcloud.com/",
   ...
   */
  def getAllTaxesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = name:ASC*/): Option[PageResourceStateTaxResource] = {
    // create path and map variables
   ...
   */
  def getTaxesUsingGET(size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = name:ASC*/): Option[PageResourceCountryTaxResource] = {
    // create path and map variables
   ...
   * @return PageResourceStateTaxResource
   */
  def getTaxesUsingGET1(countryCodeIso3: String, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = name:ASC*/): Option[PageResourceStateTaxResource] = {
    // create path and map variables
    val path = "/tax/countries/{country_code_iso3}/states".replaceAll("\\{format\\}", "json").replaceAll("\\{" + "country_code_iso3" + "\\}",apiInvoker.escape(countryCodeIso3))
