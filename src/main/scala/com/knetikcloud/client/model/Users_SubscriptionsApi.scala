...
import com.knetikcloud.client.model.SubscriptionStatusWrapper
...
class Users_SubscriptionsApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Users_SubscriptionsApiAsyncHelper(client, config)
  ...
  */
   ...
   * @return void
   */
  def setSubscriptionStatus(userId: Integer, inventoryId: Integer, status: SubscriptionStatusWrapper) = {
   ...
   * @return Future(void)
  */
  def setSubscriptionStatusAsync(userId: Integer, inventoryId: Integer, status: SubscriptionStatusWrapper) = {
...
class Users_SubscriptionsApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def setSubscriptionStatus(userId: Integer,
    inventoryId: Integer,
    status: SubscriptionStatusWrapper)(implicit reader: ClientResponseReader[Unit], writer: RequestWriter[SubscriptionStatusWrapper]): Future[Unit] = {
    // create path and map variables
    ...
    if (status == null) throw new Exception("Missing required parameter 'status' when calling Users_SubscriptionsApi->setSubscriptionStatus")
