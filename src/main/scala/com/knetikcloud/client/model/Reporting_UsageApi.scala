...
class Reporting_UsageApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Reporting_UsageApiAsyncHelper(client, config)
...
class Reporting_UsageApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
