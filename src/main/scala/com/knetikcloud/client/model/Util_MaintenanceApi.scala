...
class Util_MaintenanceApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Util_MaintenanceApiAsyncHelper(client, config)
...
class Util_MaintenanceApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
