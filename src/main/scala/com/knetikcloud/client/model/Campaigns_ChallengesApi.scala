...
class Campaigns_ChallengesApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Campaigns_ChallengesApiAsyncHelper(client, config)
  ...
  */
   ...
   */
  def getChallenges(filterActiveCampaign: Option[Boolean] = None, filterStartDate: Option[String] = None, filterEndDate: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceChallengeResource] = {
    val await = Try(Await.result(getChallengesAsync(filterActiveCampaign, filterStartDate, filterEndDate, size, page, order), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
  ...
  */
  def getChallengesAsync(filterActiveCampaign: Option[Boolean] = None, filterStartDate: Option[String] = None, filterEndDate: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Future[PageResourceChallengeResource] = {
      helper.getChallenges(filterActiveCampaign, filterStartDate, filterEndDate, size, page, order)
  }
  ...
  */
   ...
   * @return void
   */
  def updateChallengeActivity(id: Long, challengeId: Long, challengeActivityResource: Option[ChallengeActivityResource] = None, validateSettings: Option[Boolean] /* = false*/) = {
   ...
   * @return Future(void)
  */
  def updateChallengeActivityAsync(id: Long, challengeId: Long, challengeActivityResource: Option[ChallengeActivityResource] = None, validateSettings: Option[Boolean] /* = false*/) = {
...
class Campaigns_ChallengesApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def deleteChallengeActivityTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Campaigns_ChallengesApi->deleteChallengeActivityTemplate")
  ...
  def deleteChallengeTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Campaigns_ChallengesApi->deleteChallengeTemplate")
  ...
  def getChallengeActivityTemplate(id: String)(implicit reader: ClientResponseReader[TemplateResource]): Future[TemplateResource] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Campaigns_ChallengesApi->getChallengeActivityTemplate")
  ...
  def getChallengeTemplate(id: String)(implicit reader: ClientResponseReader[TemplateResource]): Future[TemplateResource] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Campaigns_ChallengesApi->getChallengeTemplate")
  ...
  def getChallenges(filterActiveCampaign: Option[Boolean] = None,
  ...
  def updateChallengeActivity(id: Long,
    ...
    challengeActivityResource: Option[ChallengeActivityResource] = None,
    validateSettings: Option[Boolean] = Some(false)
    )(implicit reader: ClientResponseReader[Unit], writer: RequestWriter[ChallengeActivityResource]): Future[Unit] = {
    // create path and map variables
    val path = (addFmt("/challenges/{challenge_id}/activities/{id}")
      replaceAll ("\\{" + "id" + "\\}",id.toString)
      replaceAll ("\\{" + "challenge_id" + "\\}",challengeId.toString))
  ...
  def updateChallengeActivityTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Campaigns_ChallengesApi->updateChallengeActivityTemplate")
  ...
  def updateChallengeTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Campaigns_ChallengesApi->updateChallengeTemplate")
