...
class Payments_FattMerchantApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Payments_FattMerchantApiAsyncHelper(client, config)
...
class Payments_FattMerchantApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
