...
class Auth_ClientsApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Auth_ClientsApiAsyncHelper(client, config)
...
class Auth_ClientsApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def deleteClient(clientKey: String)(implicit reader: ClientResponseReader[Unit]): Future[Unit] = {
    ...
    if (clientKey == null) throw new Exception("Missing required parameter 'clientKey' when calling Auth_ClientsApi->deleteClient")
  ...
  def getClient(clientKey: String)(implicit reader: ClientResponseReader[ClientResource]): Future[ClientResource] = {
    ...
    if (clientKey == null) throw new Exception("Missing required parameter 'clientKey' when calling Auth_ClientsApi->getClient")
  ...
  def setClientGrantTypes(clientKey: String,
    ...
    if (clientKey == null) throw new Exception("Missing required parameter 'clientKey' when calling Auth_ClientsApi->setClientGrantTypes")
  ...
  def setClientRedirectUris(clientKey: String,
    ...
    if (clientKey == null) throw new Exception("Missing required parameter 'clientKey' when calling Auth_ClientsApi->setClientRedirectUris")
  ...
  def updateClient(clientKey: String,
    ...
    if (clientKey == null) throw new Exception("Missing required parameter 'clientKey' when calling Auth_ClientsApi->updateClient")
