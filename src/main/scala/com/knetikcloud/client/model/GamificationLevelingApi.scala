...
class GamificationLevelingApi(val defBasePath: String = "https://sandbox.knetikcloud.com",
  ...
  */
  def getUserLevelAsync(userId: Integer, name: String): Future[UserLevelingResource] = {
   ...
   */
  def getUserLevels(userId: Integer, filterName: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] = None): Option[PageResourceUserLevelingResource] = {
  ...
  */
  def getUserLevelsAsync(userId: Integer, filterName: Option[String] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] = None): Future[PageResourceUserLevelingResource] = {
...
class GamificationLevelingApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def getUserLevel(userId: Integer,
  ...
  def getUserLevels(userId: Integer,
