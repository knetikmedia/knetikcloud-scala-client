...
class Gamification_AchievementsApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Gamification_AchievementsApiAsyncHelper(client, config)
...
class Gamification_AchievementsApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def deleteAchievement(name: String)(implicit reader: ClientResponseReader[Unit]): Future[Unit] = {
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling Gamification_AchievementsApi->deleteAchievement")
  ...
  def deleteAchievementTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Gamification_AchievementsApi->deleteAchievementTemplate")
  ...
  def getAchievement(name: String)(implicit reader: ClientResponseReader[AchievementDefinitionResource]): Future[AchievementDefinitionResource] = {
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling Gamification_AchievementsApi->getAchievement")
  ...
  def getAchievementTemplate(id: String)(implicit reader: ClientResponseReader[TemplateResource]): Future[TemplateResource] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Gamification_AchievementsApi->getAchievementTemplate")
  ...
  def getDerivedAchievements(name: String)(implicit reader: ClientResponseReader[List[AchievementDefinitionResource]]): Future[List[AchievementDefinitionResource]] = {
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling Gamification_AchievementsApi->getDerivedAchievements")
  ...
  def getUserAchievementProgress(userId: Integer,
    ...
    if (achievementName == null) throw new Exception("Missing required parameter 'achievementName' when calling Gamification_AchievementsApi->getUserAchievementProgress")
  ...
  def getUsersAchievementProgress(achievementName: String,
    ...
    if (achievementName == null) throw new Exception("Missing required parameter 'achievementName' when calling Gamification_AchievementsApi->getUsersAchievementProgress")
  ...
  def incrementAchievementProgress(userId: Integer,
    ...
    if (achievementName == null) throw new Exception("Missing required parameter 'achievementName' when calling Gamification_AchievementsApi->incrementAchievementProgress")
  ...
  def setAchievementProgress(userId: Integer,
    ...
    if (achievementName == null) throw new Exception("Missing required parameter 'achievementName' when calling Gamification_AchievementsApi->setAchievementProgress")
  ...
  def updateAchievement(name: String,
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling Gamification_AchievementsApi->updateAchievement")
  ...
  def updateAchievementTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Gamification_AchievementsApi->updateAchievementTemplate")
