...
class Gamification_TriviaApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Gamification_TriviaApiAsyncHelper(client, config)
  ...
  */
   ...
   * @return List[String]
   */
  def searchQuestionTags(filterSearch: Option[String] = None, filterCategory: Option[String] = None, filterImportId: Option[Long] = None): Option[List[String]] = {
   ...
   * @return Future(List[String])
  */
  def searchQuestionTagsAsync(filterSearch: Option[String] = None, filterCategory: Option[String] = None, filterImportId: Option[Long] = None): Future[List[String]] = {
...
class Gamification_TriviaApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def addQuestionAnswers(questionId: String,
    ...
    if (questionId == null) throw new Exception("Missing required parameter 'questionId' when calling Gamification_TriviaApi->addQuestionAnswers")
  ...
  def addQuestionTag(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Gamification_TriviaApi->addQuestionTag")
  ...
  def deleteQuestion(id: String)(implicit reader: ClientResponseReader[Unit]): Future[Unit] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Gamification_TriviaApi->deleteQuestion")
  ...
  def deleteQuestionAnswers(questionId: String,
    ...
    if (questionId == null) throw new Exception("Missing required parameter 'questionId' when calling Gamification_TriviaApi->deleteQuestionAnswers")

    if (id == null) throw new Exception("Missing required parameter 'id' when calling Gamification_TriviaApi->deleteQuestionAnswers")
  ...
  def deleteQuestionTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Gamification_TriviaApi->deleteQuestionTemplate")
  ...
  def getQuestion(id: String)(implicit reader: ClientResponseReader[QuestionResource]): Future[QuestionResource] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Gamification_TriviaApi->getQuestion")
  ...
  def getQuestionAnswer(questionId: String,
    ...
    if (questionId == null) throw new Exception("Missing required parameter 'questionId' when calling Gamification_TriviaApi->getQuestionAnswer")

    if (id == null) throw new Exception("Missing required parameter 'id' when calling Gamification_TriviaApi->getQuestionAnswer")
  ...
  def getQuestionAnswers(questionId: String)(implicit reader: ClientResponseReader[List[AnswerResource]]): Future[List[AnswerResource]] = {
    ...
    if (questionId == null) throw new Exception("Missing required parameter 'questionId' when calling Gamification_TriviaApi->getQuestionAnswers")
  ...
  def getQuestionTags(id: String)(implicit reader: ClientResponseReader[List[String]]): Future[List[String]] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Gamification_TriviaApi->getQuestionTags")
  ...
  def getQuestionTemplate(id: String)(implicit reader: ClientResponseReader[QuestionTemplateResource]): Future[QuestionTemplateResource] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Gamification_TriviaApi->getQuestionTemplate")
  ...
  def removeQuestionTag(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Gamification_TriviaApi->removeQuestionTag")

    if (tag == null) throw new Exception("Missing required parameter 'tag' when calling Gamification_TriviaApi->removeQuestionTag")
  ...
  def removeTagToQuestionsBatch(tag: String,
    ...
    if (tag == null) throw new Exception("Missing required parameter 'tag' when calling Gamification_TriviaApi->removeTagToQuestionsBatch")
  ...
  def updateQuestion(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Gamification_TriviaApi->updateQuestion")
  ...
  def updateQuestionAnswer(questionId: String,
    ...
    if (questionId == null) throw new Exception("Missing required parameter 'questionId' when calling Gamification_TriviaApi->updateQuestionAnswer")

    if (id == null) throw new Exception("Missing required parameter 'id' when calling Gamification_TriviaApi->updateQuestionAnswer")
  ...
  def updateQuestionTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Gamification_TriviaApi->updateQuestionTemplate")
