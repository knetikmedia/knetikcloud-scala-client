...
import com.knetikcloud.client.model.BasicTemplatedResource
...
class Content_ArticlesApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Content_ArticlesApiAsyncHelper(client, config)
  ...
  */
   ...
   * @return TemplateResource
   */
  def createTemplate(typeHint: String, template: Option[TemplateResource] = None): Option[TemplateResource] = {
    val await = Try(Await.result(createTemplateAsync(typeHint, template), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
   ...
   * @return Future(TemplateResource)
  */
  def createTemplateAsync(typeHint: String, template: Option[TemplateResource] = None): Future[TemplateResource] = {
      helper.createTemplate(typeHint, template)
  }
  ...
  */
   ...
   * @return void
   */
  def deleteTemplate(typeHint: String, id: String, cascade: Option[String] = None) = {
    val await = Try(Await.result(deleteTemplateAsync(typeHint, id, cascade), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
   ...
   * @return Future(void)
  */
  def deleteTemplateAsync(typeHint: String, id: String, cascade: Option[String] = None) = {
      helper.deleteTemplate(typeHint, id, cascade)
  }
  ...
  */
   ...
   * @return TemplateResource
   */
  def getTemplate(typeHint: String, id: String): Option[TemplateResource] = {
    val await = Try(Await.result(getTemplateAsync(typeHint, id), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
   ...
   * @return Future(TemplateResource)
  */
  def getTemplateAsync(typeHint: String, id: String): Future[TemplateResource] = {
      helper.getTemplate(typeHint, id)
  }
   ...
   * @return PageResourceTemplateResource
   */
  def getTemplates(typeHint: String, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Option[PageResourceTemplateResource] = {
    val await = Try(Await.result(getTemplatesAsync(typeHint, size, page, order), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
  ...
  /**
   * List and search templates asynchronously
   * &lt;b&gt;Permissions Needed:&lt;/b&gt; TEMPLATES_ADMIN
   * @param typeHint The type for the resource this template applies to 
   * @param size The number of objects returned per page (optional, default to 25)
   * @param page The number of the page returned, starting with 1 (optional, default to 1)
   ...
   * @return Future(PageResourceTemplateResource)
  */
  def getTemplatesAsync(typeHint: String, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/, order: Option[String] /* = id:ASC*/): Future[PageResourceTemplateResource] = {
      helper.getTemplates(typeHint, size, page, order)
  }
  ...
  */
   ...
   * @return TemplateResource
   */
  def updateTemplate(typeHint: String, id: String, template: Option[TemplateResource] = None): Option[TemplateResource] = {
    val await = Try(Await.result(updateTemplateAsync(typeHint, id, template), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
   ...
   * @return Future(TemplateResource)
  */
  def updateTemplateAsync(typeHint: String, id: String, template: Option[TemplateResource] = None): Future[TemplateResource] = {
      helper.updateTemplate(typeHint, id, template)
  }
   ...
   * @return void
   */
  def validate(typeHint: String, resource: Option[BasicTemplatedResource] = None) = {
    val await = Try(Await.result(validateAsync(typeHint, resource), Duration.Inf))
    await match {
      case Success(i) => Some(await.get)
      case Failure(t) => None
    }
  ...
  /**
   * Validate a templated resource asynchronously
   * Error code thrown if invalid.&lt;br&gt;&lt;br&gt;&lt;b&gt;Permissions Needed:&lt;/b&gt; TEMPLATES_ADMIN
   * @param typeHint The type for the resource this template applies to 
   * @param resource The resource to validate (optional)
   * @return Future(void)
  */
  def validateAsync(typeHint: String, resource: Option[BasicTemplatedResource] = None) = {
      helper.validate(typeHint, resource)
  }


}

class Content_ArticlesApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def createTemplate(typeHint: String,
    template: Option[TemplateResource] = None
    )(implicit reader: ClientResponseReader[TemplateResource], writer: RequestWriter[TemplateResource]): Future[TemplateResource] = {
    // create path and map variables
    val path = (addFmt("/templates/{type_hint}")
      replaceAll ("\\{" + "type_hint" + "\\}",typeHint.toString))

    // query params
    val queryParams = new mutable.HashMap[String, String]
    val headerParams = new mutable.HashMap[String, String]

    if (typeHint == null) throw new Exception("Missing required parameter 'typeHint' when calling Content_ArticlesApi->createTemplate")
  ...
  def deleteArticle(id: String)(implicit reader: ClientResponseReader[Unit]): Future[Unit] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Content_ArticlesApi->deleteArticle")
  ...
  def deleteArticleTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Content_ArticlesApi->deleteArticleTemplate")
  ...
  def deleteTemplate(typeHint: String,
    ...
    if (typeHint == null) throw new Exception("Missing required parameter 'typeHint' when calling Content_ArticlesApi->deleteTemplate")

    if (id == null) throw new Exception("Missing required parameter 'id' when calling Content_ArticlesApi->deleteTemplate")


    val resFuture = client.submit("DELETE", path, queryParams.toMap, headerParams.toMap, writer.write(cascade))
    resFuture flatMap { resp =>
      process(reader.read(resp))
    }
  }
  ...
  def getArticle(id: String)(implicit reader: ClientResponseReader[ArticleResource]): Future[ArticleResource] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Content_ArticlesApi->getArticle")
  ...
  def getArticleTemplate(id: String)(implicit reader: ClientResponseReader[TemplateResource]): Future[TemplateResource] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Content_ArticlesApi->getArticleTemplate")
  ...
  def getTemplate(typeHint: String,
    id: String)(implicit reader: ClientResponseReader[TemplateResource]): Future[TemplateResource] = {
    // create path and map variables
    val path = (addFmt("/templates/{type_hint}/{id}")
      replaceAll ("\\{" + "type_hint" + "\\}",typeHint.toString)
      replaceAll ("\\{" + "id" + "\\}",id.toString))
    ...
    if (typeHint == null) throw new Exception("Missing required parameter 'typeHint' when calling Content_ArticlesApi->getTemplate")

    if (id == null) throw new Exception("Missing required parameter 'id' when calling Content_ArticlesApi->getTemplate")
  ...
  def getTemplates(typeHint: String,
    size: Option[Integer] = Some(25),
    page: Option[Integer] = Some(1),
    order: Option[String] = Some(id:ASC)
    )(implicit reader: ClientResponseReader[PageResourceTemplateResource]): Future[PageResourceTemplateResource] = {
    ...
    if (typeHint == null) throw new Exception("Missing required parameter 'typeHint' when calling Content_ArticlesApi->getTemplates")
  ...
  def updateArticle(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Content_ArticlesApi->updateArticle")
  ...
  def updateArticleTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Content_ArticlesApi->updateArticleTemplate")
  ...
  def updateTemplate(typeHint: String,
    id: String,
    template: Option[TemplateResource] = None
    )(implicit reader: ClientResponseReader[TemplateResource], writer: RequestWriter[TemplateResource]): Future[TemplateResource] = {
    // create path and map variables
    ...
    if (typeHint == null) throw new Exception("Missing required parameter 'typeHint' when calling Content_ArticlesApi->updateTemplate")

    if (id == null) throw new Exception("Missing required parameter 'id' when calling Content_ArticlesApi->updateTemplate")
  ...
  def validate(typeHint: String,
    resource: Option[BasicTemplatedResource] = None
    )(implicit reader: ClientResponseReader[Unit], writer: RequestWriter[BasicTemplatedResource]): Future[Unit] = {
    // create path and map variables
    val path = (addFmt("/templates/{type_hint}/validate")
      replaceAll ("\\{" + "type_hint" + "\\}",typeHint.toString))
    ...
    if (typeHint == null) throw new Exception("Missing required parameter 'typeHint' when calling Content_ArticlesApi->validate")


    val resFuture = client.submit("POST", path, queryParams.toMap, headerParams.toMap, writer.write(resource))
    resFuture flatMap { resp =>
      process(reader.read(resp))
    }
  }
