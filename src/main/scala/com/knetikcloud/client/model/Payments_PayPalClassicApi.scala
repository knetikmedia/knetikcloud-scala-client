...
class Payments_PayPalClassicApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Payments_PayPalClassicApiAsyncHelper(client, config)
...
class Payments_PayPalClassicApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
