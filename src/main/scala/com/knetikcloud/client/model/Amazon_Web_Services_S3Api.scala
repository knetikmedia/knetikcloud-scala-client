...
class Amazon_Web_Services_S3Api(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Amazon_Web_Services_S3ApiAsyncHelper(client, config)
   ...
   * @param _path The path to the file relative to the bucket (the s3 object key) (optional)
...
class Amazon_Web_Services_S3ApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
