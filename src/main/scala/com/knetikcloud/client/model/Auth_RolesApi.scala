...
class Auth_RolesApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Auth_RolesApiAsyncHelper(client, config)
...
class Auth_RolesApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def deleteRole(role: String,
    ...
    if (role == null) throw new Exception("Missing required parameter 'role' when calling Auth_RolesApi->deleteRole")
  ...
  def getClientRoles(clientKey: String)(implicit reader: ClientResponseReader[List[RoleResource]]): Future[List[RoleResource]] = {
    ...
    if (clientKey == null) throw new Exception("Missing required parameter 'clientKey' when calling Auth_RolesApi->getClientRoles")
  ...
  def getRole(role: String)(implicit reader: ClientResponseReader[RoleResource]): Future[RoleResource] = {
    ...
    if (role == null) throw new Exception("Missing required parameter 'role' when calling Auth_RolesApi->getRole")
  ...
  def setClientRoles(clientKey: String,
    ...
    if (clientKey == null) throw new Exception("Missing required parameter 'clientKey' when calling Auth_RolesApi->setClientRoles")
  ...
  def setPermissionsForRole(role: String,
    ...
    if (role == null) throw new Exception("Missing required parameter 'role' when calling Auth_RolesApi->setPermissionsForRole")
  ...
  def updateRole(role: String,
    ...
    if (role == null) throw new Exception("Missing required parameter 'role' when calling Auth_RolesApi->updateRole")
