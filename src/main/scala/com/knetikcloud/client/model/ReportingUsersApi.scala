...
class ReportingUsersApi(val defBasePath: String = "https://devsandbox.knetikcloud.com",
  ...
  val helper = new ReportingUsersApiAsyncHelper(client, config)
...
class ReportingUsersApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
