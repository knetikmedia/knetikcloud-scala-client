...
class Campaigns_RewardsApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Campaigns_RewardsApiAsyncHelper(client, config)
...
class Campaigns_RewardsApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
