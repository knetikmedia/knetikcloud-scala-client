...
class Payments_StripeApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Payments_StripeApiAsyncHelper(client, config)
...
class Payments_StripeApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
