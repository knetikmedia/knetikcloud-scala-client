...
class Gamification_LeaderboardsApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Gamification_LeaderboardsApiAsyncHelper(client, config)
...
class Gamification_LeaderboardsApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def getLeaderboard(contextType: String,
    ...
    if (contextType == null) throw new Exception("Missing required parameter 'contextType' when calling Gamification_LeaderboardsApi->getLeaderboard")

    if (contextId == null) throw new Exception("Missing required parameter 'contextId' when calling Gamification_LeaderboardsApi->getLeaderboard")
  ...
  def getLeaderboardRank(contextType: String,
    ...
    if (contextType == null) throw new Exception("Missing required parameter 'contextType' when calling Gamification_LeaderboardsApi->getLeaderboardRank")

    if (contextId == null) throw new Exception("Missing required parameter 'contextId' when calling Gamification_LeaderboardsApi->getLeaderboardRank")

    if (id == null) throw new Exception("Missing required parameter 'id' when calling Gamification_LeaderboardsApi->getLeaderboardRank")
