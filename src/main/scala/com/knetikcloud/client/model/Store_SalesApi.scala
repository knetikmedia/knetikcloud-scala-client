...
class Store_SalesApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Store_SalesApiAsyncHelper(client, config)
...
class Store_SalesApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
