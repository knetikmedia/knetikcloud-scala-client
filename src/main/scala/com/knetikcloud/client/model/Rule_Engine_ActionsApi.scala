...
class Rule_Engine_ActionsApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Rule_Engine_ActionsApiAsyncHelper(client, config)
...
class Rule_Engine_ActionsApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
