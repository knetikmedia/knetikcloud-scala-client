...
class Media_VideosApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Media_VideosApiAsyncHelper(client, config)
...
class Media_VideosApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def deleteVideoTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Media_VideosApi->deleteVideoTemplate")
  ...
  def getVideoTemplate(id: String)(implicit reader: ClientResponseReader[TemplateResource]): Future[TemplateResource] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Media_VideosApi->getVideoTemplate")
  ...
  def updateVideoTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Media_VideosApi->updateVideoTemplate")
