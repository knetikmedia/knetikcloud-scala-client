...
class Payments_TransactionsApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Payments_TransactionsApiAsyncHelper(client, config)
...
class Payments_TransactionsApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
