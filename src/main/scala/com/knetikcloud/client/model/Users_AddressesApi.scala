...
class Users_AddressesApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Users_AddressesApiAsyncHelper(client, config)
...
class Users_AddressesApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def createAddress(userId: String,
    ...
    if (userId == null) throw new Exception("Missing required parameter 'userId' when calling Users_AddressesApi->createAddress")
  ...
  def deleteAddress(userId: String,
    ...
    if (userId == null) throw new Exception("Missing required parameter 'userId' when calling Users_AddressesApi->deleteAddress")
  ...
  def getAddress(userId: String,
    ...
    if (userId == null) throw new Exception("Missing required parameter 'userId' when calling Users_AddressesApi->getAddress")
  ...
  def getAddresses(userId: String,
    ...
    if (userId == null) throw new Exception("Missing required parameter 'userId' when calling Users_AddressesApi->getAddresses")
  ...
  def updateAddress(userId: String,
    ...
    if (userId == null) throw new Exception("Missing required parameter 'userId' when calling Users_AddressesApi->updateAddress")
