...
import com.knetikcloud.client.model.InventoryStatusWrapper
...
class Users_InventoryApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Users_InventoryApiAsyncHelper(client, config)
  ...
  */
   ...
   * @return void
   */
  def updateUserInventoryStatus(userId: Integer, id: Integer, inventoryStatus: Option[InventoryStatusWrapper] = None) = {
   ...
   * @return Future(void)
  */
  def updateUserInventoryStatusAsync(userId: Integer, id: Integer, inventoryStatus: Option[InventoryStatusWrapper] = None) = {
...
class Users_InventoryApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def checkUserEntitlementItem(userId: String,
    ...
    if (userId == null) throw new Exception("Missing required parameter 'userId' when calling Users_InventoryApi->checkUserEntitlementItem")
  ...
  def deleteEntitlementTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Users_InventoryApi->deleteEntitlementTemplate")
  ...
  def getEntitlementTemplate(id: String)(implicit reader: ClientResponseReader[ItemTemplateResource]): Future[ItemTemplateResource] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Users_InventoryApi->getEntitlementTemplate")
  ...
  def getUserInventory(userId: String,
    ...
    if (userId == null) throw new Exception("Missing required parameter 'userId' when calling Users_InventoryApi->getUserInventory")
  ...
  def getUserInventoryLog(userId: String,
    ...
    if (userId == null) throw new Exception("Missing required parameter 'userId' when calling Users_InventoryApi->getUserInventoryLog")
  ...
  def grantUserEntitlement(userId: Integer,
    ...
    if (grantRequest == null) throw new Exception("Missing required parameter 'grantRequest' when calling Users_InventoryApi->grantUserEntitlement")
  ...
  def updateEntitlementTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Users_InventoryApi->updateEntitlementTemplate")
  ...
  def updateUserInventoryStatus(userId: Integer,
    id: Integer,
    inventoryStatus: Option[InventoryStatusWrapper] = None
    )(implicit reader: ClientResponseReader[Unit], writer: RequestWriter[InventoryStatusWrapper]): Future[Unit] = {
    // create path and map variables
  ...
  def useUserEntitlementItem(userId: String,
    ...
    if (userId == null) throw new Exception("Missing required parameter 'userId' when calling Users_InventoryApi->useUserEntitlementItem")
