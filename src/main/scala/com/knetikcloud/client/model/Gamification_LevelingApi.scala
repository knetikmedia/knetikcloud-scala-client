...
class Gamification_LevelingApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Gamification_LevelingApiAsyncHelper(client, config)
...
class Gamification_LevelingApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def deleteLevel(name: String)(implicit reader: ClientResponseReader[Unit]): Future[Unit] = {
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling Gamification_LevelingApi->deleteLevel")
  ...
  def getLevel(name: String)(implicit reader: ClientResponseReader[LevelingResource]): Future[LevelingResource] = {
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling Gamification_LevelingApi->getLevel")
  ...
  def getUserLevel(userId: String,
    ...
    if (userId == null) throw new Exception("Missing required parameter 'userId' when calling Gamification_LevelingApi->getUserLevel")

    if (name == null) throw new Exception("Missing required parameter 'name' when calling Gamification_LevelingApi->getUserLevel")
  ...
  def getUserLevels(userId: String,
    ...
    if (userId == null) throw new Exception("Missing required parameter 'userId' when calling Gamification_LevelingApi->getUserLevels")
  ...
  def incrementProgress(userId: Integer,
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling Gamification_LevelingApi->incrementProgress")
  ...
  def setProgress(userId: Integer,
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling Gamification_LevelingApi->setProgress")
  ...
  def updateLevel(name: String,
    ...
    if (name == null) throw new Exception("Missing required parameter 'name' when calling Gamification_LevelingApi->updateLevel")
