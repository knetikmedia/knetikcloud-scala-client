...
class Rule_Engine_GlobalsApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Rule_Engine_GlobalsApiAsyncHelper(client, config)
...
class Rule_Engine_GlobalsApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def deleteBREGlobal(id: String)(implicit reader: ClientResponseReader[Unit]): Future[Unit] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Rule_Engine_GlobalsApi->deleteBREGlobal")
  ...
  def getBREGlobal(id: String)(implicit reader: ClientResponseReader[BreGlobalResource]): Future[BreGlobalResource] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Rule_Engine_GlobalsApi->getBREGlobal")
  ...
  def updateBREGlobal(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Rule_Engine_GlobalsApi->updateBREGlobal")
