...
class Store_SubscriptionsApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Store_SubscriptionsApiAsyncHelper(client, config)
...
class Store_SubscriptionsApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def deleteSubscription(id: Integer,
    ...
    if (planId == null) throw new Exception("Missing required parameter 'planId' when calling Store_SubscriptionsApi->deleteSubscription")
  ...
  def deleteSubscriptionTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Store_SubscriptionsApi->deleteSubscriptionTemplate")
  ...
  def getSubscriptionTemplate(id: String)(implicit reader: ClientResponseReader[SubscriptionTemplateResource]): Future[SubscriptionTemplateResource] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Store_SubscriptionsApi->getSubscriptionTemplate")
  ...
  def updateSubscriptionTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Store_SubscriptionsApi->updateSubscriptionTemplate")
