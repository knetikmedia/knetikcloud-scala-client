...
class Reporting_UsersApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Reporting_UsersApiAsyncHelper(client, config)
  ...
  def getUserRegistrations(granularity: Option[String] /* = day*/, startDate: Option[Long] = None, endDate: Option[Long] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Option[PageResourceAggregateCountResource] = {
    val await = Try(Await.result(getUserRegistrationsAsync(granularity, startDate, endDate, size, page), Duration.Inf))
    await match {
   ...
   * @param size The number of objects returned per page (optional, default to 25)
   * @param page The number of the page returned, starting with 1 (optional, default to 1)
   * @return Future(PageResourceAggregateCountResource)
  */
  def getUserRegistrationsAsync(granularity: Option[String] /* = day*/, startDate: Option[Long] = None, endDate: Option[Long] = None, size: Option[Integer] /* = 25*/, page: Option[Integer] /* = 1*/): Future[PageResourceAggregateCountResource] = {
      helper.getUserRegistrations(granularity, startDate, endDate, size, page)
  }


}

class Reporting_UsersApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {

  def getUserRegistrations(granularity: Option[String] = Some(day),
    startDate: Option[Long] = None,
    endDate: Option[Long] = None,
    size: Option[Integer] = Some(25),
    page: Option[Integer] = Some(1)
    )(implicit reader: ClientResponseReader[PageResourceAggregateCountResource]): Future[PageResourceAggregateCountResource] = {
    // create path and map variables
    val path = (addFmt("/reporting/users/registrations"))
