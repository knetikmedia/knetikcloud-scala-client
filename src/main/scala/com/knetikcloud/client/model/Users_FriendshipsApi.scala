...
class Users_FriendshipsApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Users_FriendshipsApiAsyncHelper(client, config)
...
class Users_FriendshipsApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def addFriend(userId: String,
    ...
    if (userId == null) throw new Exception("Missing required parameter 'userId' when calling Users_FriendshipsApi->addFriend")
  ...
  def getFriends(userId: String,
    ...
    if (userId == null) throw new Exception("Missing required parameter 'userId' when calling Users_FriendshipsApi->getFriends")
  ...
  def getInviteToken(userId: String)(implicit reader: ClientResponseReader[String]): Future[String] = {
    ...
    if (userId == null) throw new Exception("Missing required parameter 'userId' when calling Users_FriendshipsApi->getInviteToken")
  ...
  def getInvites(userId: String,
    ...
    if (userId == null) throw new Exception("Missing required parameter 'userId' when calling Users_FriendshipsApi->getInvites")
  ...
  def redeemFriendshipToken(userId: String,
    ...
    if (userId == null) throw new Exception("Missing required parameter 'userId' when calling Users_FriendshipsApi->redeemFriendshipToken")
  ...
  def removeOrDeclineFriend(userId: String,
    ...
    if (userId == null) throw new Exception("Missing required parameter 'userId' when calling Users_FriendshipsApi->removeOrDeclineFriend")
