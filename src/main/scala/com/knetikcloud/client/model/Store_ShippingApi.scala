...
class Store_ShippingApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Store_ShippingApiAsyncHelper(client, config)
...
class Store_ShippingApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def deleteShippingTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Store_ShippingApi->deleteShippingTemplate")
  ...
  def getShippingTemplate(id: String)(implicit reader: ClientResponseReader[ItemTemplateResource]): Future[ItemTemplateResource] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Store_ShippingApi->getShippingTemplate")
  ...
  def updateShippingTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Store_ShippingApi->updateShippingTemplate")
