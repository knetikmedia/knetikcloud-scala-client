...
class Store_CouponsApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Store_CouponsApiAsyncHelper(client, config)
...
class Store_CouponsApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def deleteCouponTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Store_CouponsApi->deleteCouponTemplate")
  ...
  def getCouponItemBySku(sku: String)(implicit reader: ClientResponseReader[CouponItem]): Future[CouponItem] = {
    ...
    if (sku == null) throw new Exception("Missing required parameter 'sku' when calling Store_CouponsApi->getCouponItemBySku")
  ...
  def getCouponTemplate(id: String)(implicit reader: ClientResponseReader[ItemTemplateResource]): Future[ItemTemplateResource] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Store_CouponsApi->getCouponTemplate")
  ...
  def updateCouponTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Store_CouponsApi->updateCouponTemplate")
