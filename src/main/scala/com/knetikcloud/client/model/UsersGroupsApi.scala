...
class UsersGroupsApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def deleteGroupMemberTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling UsersGroupsApi->deleteGroupMemberTemplate")
  ...
  def getGroupMemberTemplate(id: String)(implicit reader: ClientResponseReader[TemplateResource]): Future[TemplateResource] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling UsersGroupsApi->getGroupMemberTemplate")
  ...
  def updateGroupMemberProperties(uniqueName: String,
    ...
    if (uniqueName == null) throw new Exception("Missing required parameter 'uniqueName' when calling UsersGroupsApi->updateGroupMemberProperties")

    if (order == null) throw new Exception("Missing required parameter 'order' when calling UsersGroupsApi->updateGroupMemberProperties")
  ...
  def updateGroupMemberProperties1(uniqueName: String,
    ...
    if (uniqueName == null) throw new Exception("Missing required parameter 'uniqueName' when calling UsersGroupsApi->updateGroupMemberProperties1")
  ...
  def updateGroupMemberTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling UsersGroupsApi->updateGroupMemberTemplate")
