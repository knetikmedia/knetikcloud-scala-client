...
class Payments_OptimalApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Payments_OptimalApiAsyncHelper(client, config)
...
class Payments_OptimalApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
