...
class Media_PollsApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Media_PollsApiAsyncHelper(client, config)
...
class Media_PollsApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def answerPoll(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Media_PollsApi->answerPoll")
  ...
  def deletePoll(id: String)(implicit reader: ClientResponseReader[Unit]): Future[Unit] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Media_PollsApi->deletePoll")
  ...
  def deletePollTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Media_PollsApi->deletePollTemplate")
  ...
  def getPoll(id: String)(implicit reader: ClientResponseReader[PollResource]): Future[PollResource] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Media_PollsApi->getPoll")
  ...
  def getPollAnswer(id: String)(implicit reader: ClientResponseReader[PollResponseResource]): Future[PollResponseResource] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Media_PollsApi->getPollAnswer")
  ...
  def getPollTemplate(id: String)(implicit reader: ClientResponseReader[TemplateResource]): Future[TemplateResource] = {
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Media_PollsApi->getPollTemplate")
  ...
  def updatePoll(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Media_PollsApi->updatePoll")
  ...
  def updatePollTemplate(id: String,
    ...
    if (id == null) throw new Exception("Missing required parameter 'id' when calling Media_PollsApi->updatePollTemplate")
