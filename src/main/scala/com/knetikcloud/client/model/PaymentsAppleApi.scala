...
class PaymentsAppleApi(val defBasePath: String = "https://sandbox.knetikcloud.com",
  ...
  val helper = new PaymentsAppleApiAsyncHelper(client, config)
...
class PaymentsAppleApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
