...
class Users_RelationshipsApi(val defBasePath: String = "https://jsapi-integration.us-east-1.elasticbeanstalk.com",
  ...
  val helper = new Users_RelationshipsApiAsyncHelper(client, config)
...
class Users_RelationshipsApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
